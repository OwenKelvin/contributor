...
@Component({
  selector: 'nyots-contribution-form-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    <div class="p-6">
      <div class="mb-6">
        <h2 class="text-2xl font-bold">Record Contribution</h2>
      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
        ...
        <div class="space-y-2">
          ...
          <p class="text-xs text-muted-foreground">
            Enter a reference number for offline payments
          </p>
        </div>
...
export class ContributionFormDialogComponent {
  ...
  async onSubmit() {
    ...
    try {
      ...
      // Emit the created contribution
      if (contribution) {
        this.contributionCreated.emit(contribution);
      }
