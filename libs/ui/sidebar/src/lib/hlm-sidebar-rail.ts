...
export class HlmSidebarRail {
	...
	constructor() {
		classes(() => [
			'hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1 after:w-[2px] sm:flex',
