...
import { HlmCalendar } from '@nyots/ui/calendar';
import { HlmPopoverImports } from '@nyots/ui/popover';
...
@Component({
  ...
  imports: [HlmIcon, NgIcon, BrnPopoverImports, HlmPopoverImports, HlmCalendar],
  providers: [
